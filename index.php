...
<style>
  ...
  .navbar-brand img {
    ...
    /* Adjust logo size */
    margin-right: 10px;
    /* Space between the logo and brand name */
    transition: all 0.3s ease;
  }
...
<body id="page-top">
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto my-2 my-lg-0">
          ...
          &nbsp;&nbsp;&nbsp;
          <li class="nav-item">
            <a href="project/login.php" class="nav-link text-white d-flex align-items-center">
              <img width="30" height="30" src="https://img.icons8.com/matisse/100/exit.png" alt="exit" class="me-2" />
              Logout
            </a>
          </li>


          <!-- <li class="nav-item"><a class="nav-link js-scroll-trigger text-white" href="project\login.php">Logout</a></li> -->
  ...
  <div class="container my-5">
    <h2 class="text-center mb-4" style="color: #1a237e;">Frequently Asked Questions</h2>
    <div class="faq-section">
        <div class="faq-item">
            <h5 class="faq-question" onclick="toggleAnswer(1)">1. How can I book an event? <span>&#x25BC;</span></h5>
            <p class="faq-answer" id="answer-1">If you want to book a venue or event, you need to first complete the payment. After that, a reference ID will be generated. You need to copy and paste this ID into the booking form for the particular event.</p>
        </div>
        <div class="faq-item">
            <h5 class="faq-question" onclick="toggleAnswer(2)">2. Can I customize the event packages? <span>&#x25BC;</span></h5>
            <p class="faq-answer" id="answer-2">Yes, we offer customizable packages to meet your specific needs. You can choose the services you require, and we'll create a tailored package for you.</p>
        </div>
    </div>
</div>
...
.faq-question:hover {
    color: #3949ab; /* Slightly lighter blue on hover */
}
