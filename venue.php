...
<header class="masthead">
    <img src="../assets/Venue banner.jpg" alt="" srcset="">
</header>
                                    ...
                                    <div class="">
                                        ...
                                        <div>
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <button class="btn btn-primary book-venue align-self-end mr-2" type="button" data-id='<?php echo $row['id'] ?>'>Book</button>
                                                <button class="btn btn-success payment-btn align-self-end" type="button" onclick="redirectToPayment(<?php echo $row['id']; ?>)">Payment</button>
                                            </div>
                                        </div>
...
<script>
    // Existing JavaScript for booking
    ...
    function redirectToPayment(venueId) {
        window.location.href = "/Event_Management_System/razorpay/index.php" ; // payment page link
    }
</script>
